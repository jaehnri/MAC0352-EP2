...
run-client-docker-udp: build-client-docker
...
# Test with 2 inactive clients
test-2-clients:
	rm -rf test-outputs/2/
	mkdir test-outputs/2/
	./scripts/tests/2/test-2-clients.sh test-outputs/2/cpu-2-test test-outputs/2/network-2-test

# Test with 2 active clients
